...
<html>
    ...
    <body>
        ...
        <form:form action="/SpringMVCHibernate/person/add" modelAttribute="itemListContainer" method="post" id="personListForm">
            <table>
                <thead>
                    <tr>
                        <th>Name</th>
                ...
                <tbody id="personListContainer">
                    <c:forEach items="${itemListContainer.itemList}" var="Item" varStatus="i" begin="0" >
                        <tr class="person">    
                            <td><form:input path="itemList[${i.index}].name" id="name${i.index}" /></td>
                            <td><form:input path="itemList[${i.index}].price" id="price${i.index}" /></td>
                            <%--
                            <td><input type="text" name="itemList[].name" value="${Person.name}" /></td>
                            <td><input type="text" name="itemList[].age" value="${Person.price}" /></td>
                            --%>
                    ...
                    --%>
                    <c:if test="${itemListContainer.itemList.size() == 0}">
                        <tr class="person defaultRow">    
                            <td><input type="text" name="itemList[].name" value="" /></td>
                            <td><input type="text" name="itemList[].price" value="" /></td>

                            <td><a href="#" class="removePerson">Remove Item</a></td>
                        </tr>
                    </c:if>
                </tbody>
            </table>
        ...
        <script type="text/javascript">
            ...
            $(document).ready( function() {
                var config = {
                    ...
                    indexedPropertyMemberNames : 'name,price',
